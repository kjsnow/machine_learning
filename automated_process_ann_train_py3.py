...
def main():
	...
	start_date =  dt.datetime.now().date() - dt.timedelta(days=5) #dt.date(2018,6,10)
	#start_date = start_date.strftime("%Y-%m-%d")
	end_date = start_date + dt.timedelta(days=2) #dt.date(2018,6,13)
	...
	from com_cdm_stage..f_final_churn_reporting where churn_date >= '2018-06-29' and churn_date < '2018-07-02' and churn_losing_sp in (1,2,3,4,6) and churn_type like '%DSV' and noncompetitive_ind in (0,5)
	),
	cte_minute as (
